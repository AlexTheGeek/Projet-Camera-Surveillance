...
def my_callback(channel):
    ...
    msg = MIMEMultipart()
    msg['From'] = 'adressemail@gmail.com'
    msg['To'] = 'adressemail@gmail.com'
    ...
    mailserver.starttls()
    mailserver.ehlo()
    mailserver.login('adressemail@gmail.com', 'mdp')
    mailserver.sendmail('adressemail@gmail.com','adressemail@gmail.com', msg.as_string())
    mailserver.quit()
